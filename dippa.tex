...
Black-box testing & A testing strategy that considers a functional design specification to design test cases without regard to internal program structure. \citep{pezze2008software} \\[0.3cm]

Bug & See \emph{defect}. \\[0.3cm]

Component testing & def \\[0.3cm]

Continuous testing & def \\[0.3cm]

Defect & A flaw in the system that causes the system or component to fail to perform its function. \citep{pezze2008software} \\[0.3cm]

ESB & Enterprise service bus a \\[0.3cm]

failure & def \\[0.3cm]

fault & def \\[0.3cm]

fauilt based testing & def \\[0.3cm]

Framework & An abstract design which can be extended by adding more or better components to it. An important characteristic of a framework that differentiates it from libraries is that the methods defined by the user to tailor the framework are called from within the framework itself. The framework often plays the role of the main program in coordinating and sequencing application activity. (Johnson and Foote, 1988) \\[0.3cm]

functional testing & def \\[0.3cm]

integration testing & orderly progression of testing where individal software and hardware elements are combined and tested until entire system has been integrated (pezze) see also ieec \\[0.3cm]

Integration Testing & A level of test undertaken to validate the interface between internal components of a system. Typically based upon the system architecture. (Craig and Jaskiel, 2002) \\[0.3cm]

Library & A controlled collection of software and related documentation designed to aid in software development, use, or maintenance. See also framework. (IEEE Std 610.12-1990) \\[0.3cm]

model-based testing & def \\[0.3cm]
...
record/capture and playback & test tool records testi poutand outcomes and prvides fafilites for suseuqent re-execotion or replay of test (pezze) \\[0.3cm]

regression testing & proicess of reesting software that has been modofied to unsure that no defects have been uintorudce bt the modifcation and software stilla ble to meet its specification (pezze) \\[0.3cm]

retesting & def \\[0.3cm]

SOA & Serviceoriented architecture A software architecutre principle where \\[0.3cm]
...
System Under Test (SUT) & The entire system or product to be tested. (Craig and Jaskiel, 2002) \\[0.3cm]
...
software component \\[0.3cm]

testing framework & def \\[0.3cm]

unit testing & aggregate of techincal activities inviolved in demonstrating that an indiviudal software unit has been implemented correctly athat the code and the design of a unit are consiten and that the unit design is correct (pezze) \\[0.3cm]

UTF & Unified testing framework \\[0.3cm]

validation & the process of evaluting a software system or coponetn during or at the end of the devlopment cycle to evalut wheter it meets the customers requirments \\[0.3cm]

verification & process of evaluating a softwrae stystem or compoent to detmine whter theproducts of a given devlopment phase satisfy the conditions ompised ath the star that phase (pezze) \\[0.3cm]

white-box testing & basec strategy that requires knowledge of the internal structure of a program to design test cases (pezze) \\[0.3cm]

WSDL & Web service description language, an XML-based definition of a web service interface \\[0.3cm]
