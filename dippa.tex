...
Record and playback & An approach where a test tool records test input and outcomes and prvovides facilities for subsequent re-execution or replay of test. \citep{burnstein2003practical} \\[0.3cm]
