...
black-box testing & testing strategy that considers a finctioanl design sspeification to design test cases without regard to interanl program stracture (pezze) \\[0.5cm]

bug & def \\[0.5cm]

Component testing & def \\[0.5cm]

continuous testing & def \\[0.5cm]

defect also bug & a flaw in the system that causes the system or component to fail to perform its function (pezze) \\[0.5cm]

ESB & Enterprise service bus a \\[0.5cm]

failure & def \\[0.5cm]

fault & def \\[0.5cm]

fauilt based testing & def \\[0.5cm]

Framework & An abstract design which can be extended by adding more or better components to it. An important characteristic of a framework that differentiates it from libraries is that the methods defined by the user to tailor the framework are called from within the framework itself. The framework often plays the role of the main program in coordinating and sequencing application activity. (Johnson and Foote, 1988) \\[0.5cm]

functional testing & def \\[0.5cm]

integration testing & orderly progression of testing where individal software and hardware elements are combined and tested until entire system has been integrated (pezze) see also ieec \\[0.5cm]

Integration Testing & A level of test undertaken to validate the interface between internal components of a system. Typically based upon the system architecture. (Craig and Jaskiel, 2002) \\[0.5cm]

Library & A controlled collection of software and related documentation designed to aid in software development, use, or maintenance. See also framework. (IEEE Std 610.12-1990) \\[0.5cm]

model-based testing & def \\[0.5cm]

mock service & def \\[0.5cm]

non-functional testing & def \\[0.5cm]

oracle & def \\[0.5cm]

record/capture and playback & test tool records testi poutand outcomes and prvides fafilites for suseuqent re-execotion or replay of test (pezze) \\[0.5cm]

regression testing & proicess of reesting software that has been modofied to unsure that no defects have been uintorudce bt the modifcation and software stilla ble to meet its specification (pezze) \\[0.5cm]

retesting & def \\[0.5cm]

SOA & Serviceoriented architecture A software architecutre principle where \\[0.5cm]

surrogate & def \\[0.5cm]

system testing & process of testing an integration hardward and softwre ststem to very that the system meets ists specified requirements \\[0.5cm]

System Under Test (SUT) & The entire system or product to be tested. (Craig and Jaskiel, 2002) \\[0.5cm]

Test Automation Framework & A framework used for test automation. Provides some core functionality (e.g. logging and reporting) and allows its testing capabilities to be extended by adding new test libraries. \\[0.5cm]

test case & test related item which contains test inptuts, execution condictiosna dn expected outputs
software component \\[0.5cm]

testing framework & def \\[0.5cm]

unit testing & aggregate of techincal activities inviolved in demonstrating that an indiviudal software unit has been implemented correctly athat the code and the design of a unit are consiten and that the unit design is correct (pezze) \\[0.5cm]

UTF & Unified testing framework \\[0.5cm]

validation & the process of evaluting a software system or coponetn during or at the end of the devlopment cycle to evalut wheter it meets the customers requirments \\[0.5cm]

verification & process of evaluating a softwrae stystem or compoent to detmine whter theproducts of a given devlopment phase satisfy the conditions ompised ath the star that phase (pezze) \\[0.5cm]

white-box testing & basec strategy that requires knowledge of the internal structure of a program to design test cases (pezze) \\[0.5cm]

WSDL & Web service description language, an XML-based definition of a web service interface \\[0.5cm]
