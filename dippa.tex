...
Test case & Test related item which contains test inptuts, execution conditions, and expected outputs. \citep{pezze2008softare} \\[0.3cm]
...
UTF & \textbf{U}nified \textbf{T}esting \textbf{F}ramework \\[0.3cm]
...
WSDL & \textbf{W}eb \textbf{S}ervice \textbf{D}escription \textbf{L}anguage, an XML-based definition of a web service interface \\[0.3cm]
