...
black-box testing & testing strategy that considers a finctioanl design sspeification to design test cases without regard to interanl program stracture (pezze) \\

bug & def \\

Component testing & def \\

continuous testing & def \\

defect also bug & a flaw in the system that causes the system or component to fail to perform its function (pezze) \\

ESB & Enterprise service bus a \\

failure & def \\

fault & def \\

fauilt based testing & def \\

functional testing & def \\


integration testing & orderly progression of testing where individal software and hardware elements are combined and tested until entire system has been integrated (pezze) see also ieec \\
...
model-based testing & def \\

mock service & def \\

non-functional testing & def \\

oracle & def \\

record/capture and playback & test tool records testi poutand outcomes and prvides fafilites for suseuqent re-execotion or replay of test (pezze) \\

regression testing & proicess of reesting software that has been modofied to unsure that no defects have been uintorudce bt the modifcation and software stilla ble to meet its specification (pezze) \\

retesting & def \\

SOA & Serviceoriented architecture A software architecutre principle where \\

surrogate & def \\

system testing & process of testing an integration hardward and softwre ststem to very that the system meets ists specified requirements \\
...
testing framework & def \\

unit testing & aggregate of techincal activities inviolved in demonstrating that an indiviudal software unit has been implemented correctly athat the code and the design of a unit are consiten and that the unit design is correct (pezze) \\

UTF & Unified testing framework \\

white-box testing & basec strategy that requires knowledge of the internal structure of a program to design test cases (pezze) \\

WSDL & Web service description language, an XML-based definition of a web service interface \\
...
validation & the process of evaluting a software system or coponetn during or at the end of the devlopment cycle to evalut wheter it meets the customers requirments \\ 
verification & process of evaluating a softwrae stystem or compoent to detmine whter theproducts of a given devlopment phase satisfy the conditions ompised ath the star that phase (pezze) \\
