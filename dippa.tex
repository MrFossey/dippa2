...
Record and playback & An approach where a test tool records test input and outcomes and prvovides facilities for subsequent re-execution or replay of test. \citep{pezze2008software} \\[0.3cm]

Regression testing & Process of retesting software that has been modified to ensure that no defects have been introduced bt the modifcation and software still are able to meet its specification. \citep{pezze2008software} \\[0.3cm]
