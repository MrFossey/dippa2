...
Regression testing & Retesting software that has been modified to ensure that no defects have been introduced by the modification and that the software still satisfies its functional specification. \citep{burnstein2003practical} \\[0.3cm]
