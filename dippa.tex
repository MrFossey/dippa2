...
Regression testing & Process of retesting software that has been modified to ensure that no defects have been introduced bt the modifcation and software still are able to meet its specification. \citep{burnstein2003practical} \\[0.3cm]
