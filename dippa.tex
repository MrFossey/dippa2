...
Continuous integration & A development practice where team mebers integrate theiw work frequently and each integration is verfified by an automated build which include tests to detect integrations flaws as quickly as possible. \citep{duvall2007continuous} \\[0.3cm]
