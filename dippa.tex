...
Black-box testing & A testing strategy that considers a functional design specification to design test cases without regard to internal program structure. \citep{pezze2008softare} \\[0.3cm]
...
defect also bug & a flaw in the system that causes the system or component to fail to perform its function (pezze) \\[0.3cm]
